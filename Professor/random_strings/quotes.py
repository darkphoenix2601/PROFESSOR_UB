...
GDNOON = [
    ...
    "`If you feel tired and sleepy you could use a nap, you will see that it will d3vlp you recover your energy and feel much better to finish the day. Have a beautiful afternoon!`",
